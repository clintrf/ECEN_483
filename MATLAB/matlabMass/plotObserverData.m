classdef plotObserverData < handle
    ...
    methods
        ...
        function self = updatePlots(self, t, x, xhat)
            ...
            self.z_history(self.index) = x(1);%180/pi*x(1);
            self.z_dot_history(self.index) = x(2);%180/pi*x(2);
            self.z_hat_history(self.index) = xhat(1);%180/pi*xhat(1);
            self.z_hat_dot_history(self.index) = xhat(2);%180/pi*xhat(2);
